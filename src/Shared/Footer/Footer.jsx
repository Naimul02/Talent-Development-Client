...
const Footer = () => {
  return (
    <div>
      <footer className="footer px-20 py-10  bg-blue-800 text-white">
        <aside>
          <img
      ...
      <hr />
      <footer className="footer footer-center p-4 bg-blue-800 text-base-content">
        <aside>
          <p className="text-white">
            Copyright © 2024 - All right reserved by Talent Development
          </p>
        </aside>
      </footer>
    </div>
